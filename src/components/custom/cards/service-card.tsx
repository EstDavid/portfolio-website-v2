...
export default function ServiceCard ({ service }: { service: ServiceData; }) {
  ...
  return (
    <div className="flex flex-col gap-4 w-full p-4 bg-background dark:border dark:border-primary dark:shadow-primary dark:shadow-md rounded-2xl shadow-lg transition-transform duration-200 hover:scale-110"
    >
